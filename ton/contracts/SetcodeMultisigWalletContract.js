...
class SetcodeMultisigWalletContract {
    ...
    */
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_submitTransaction
     * @type {object}
     ...
     * @param {cell} params.payload
     * @return {Promise.<SetcodeMultisigWalletContract_submitTransaction>}
     */
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_isConfirmed
     * @type {object}
     ...
     * @return {Promise.<SetcodeMultisigWalletContract_isConfirmed>}
     */
    isConfirmed(params) {
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_getParameters
     * @type {object}
    ...
    /**
     * @return {Promise.<SetcodeMultisigWalletContract_getParameters>}
     */
    getParameters() {
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_getTransaction
     * @type {object}
     ...
     * @param {object} params
     * @param {uint64} params.transactionId
     * @return {Promise.<SetcodeMultisigWalletContract_getTransaction>}
     */
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_getTransactions
     * @type {object}
     * @property {tuple[]} transactions 
     */

    /**
     * @return {Promise.<SetcodeMultisigWalletContract_getTransactions>}
     */
    getTransactions() {
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_getTransactionIds
     * @type {object}
     * @property {uint64[]} ids 
     */

    /**
     * @return {Promise.<SetcodeMultisigWalletContract_getTransactionIds>}
     */
    getTransactionIds() {
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_getCustodians
     * @type {object}
     * @property {tuple[]} custodians 
     */

    /**
     * @return {Promise.<SetcodeMultisigWalletContract_getCustodians>}
     */
    getCustodians() {
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_submitUpdate
     * @type {object}
     ...
     * @return {Promise.<SetcodeMultisigWalletContract_submitUpdate>}
     */
    submitUpdate(params) {
    ...
    /**
     * @typedef SetcodeMultisigWalletContract_getUpdateRequests
     * @type {object}
     * @property {tuple[]} updates 
     */

    /**
     * @return {Promise.<SetcodeMultisigWalletContract_getUpdateRequests>}
     */
    getUpdateRequests() {
...
SetcodeMultisigWalletContract.package = pkg;
